...
namespace ompl
{
    namespace control
    {
        class ConstraintRespectingBSST : public ConstraintRespectingPlanner
        {
        public:
            /** \brief Constructor */
            ConstraintRespectingBSST(const SpaceInformationPtr &si);

            ~ConstraintRespectingBSST() override;
